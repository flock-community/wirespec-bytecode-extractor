...
```
groupId:    community.flock.wirespec.extractor
...
- **Goal:** `wirespec:extract` (full: `wirespec-extractor:extract`).
...
├── src/
│   ├── main/
│   │   └── kotlin/community/flock/wirespec/extractor/
│   │       ├── ExtractMojo.kt
│   │       ├── ClasspathBuilder.kt
...
└── docs/superpowers/specs/
    └── 2026-05-12-wirespec-extractor-design.md
```
