...
import community.flock.wirespec.extractor.fixtures.dsl.JavaWebFluxRouterConfig
import community.flock.wirespec.extractor.fixtures.dsl.MvcRouterConfig
import community.flock.wirespec.extractor.fixtures.dsl.WebFluxCoRouterConfig
import community.flock.wirespec.extractor.fixtures.dsl.WebFluxRouterConfig
    ...
    fun `resolves Kotlin DSL handler method references`() {
        ...
        routes.forEach {
            it.handlerOwnerInternal shouldBe
                "community/flock/wirespec/extractor/fixtures/dsl/WebFluxRouterHandler"
        }
    }
