...
class TypeExtractorTest {
    ...
    fun `two classes with same simple name across packages get disambiguated names`() {
        ...
        val r1 = freshExtractor.extract(community.flock.wirespec.extractor.fixtures.dto.clashA.Conflict::class.java)
        val r2 = freshExtractor.extract(community.flock.wirespec.extractor.fixtures.dto.clashB.Conflict::class.java)
    ...
    fun `JSpecify @NullMarked record defaults to non-null and honors @Nullable`() {
        extractor.extract(community.flock.wirespec.extractor.fixtures.dto.jspecify.NullMarkedDto::class.java)
    ...
    fun `JSpecify @Nullable and @NonNull decide per-field without @NullMarked`() {
        extractor.extract(community.flock.wirespec.extractor.fixtures.dto.jspecify.PlainNullnessDto::class.java)
