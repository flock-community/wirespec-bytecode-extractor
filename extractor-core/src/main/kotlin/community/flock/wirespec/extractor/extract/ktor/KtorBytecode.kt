...
internal object KtorBytecode {
    ...
    val SERVER_HTTP_METHODS = mapOf(
        "get" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.GET,
        "post" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.POST,
        "put" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.PUT,
        "patch" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.PATCH,
        "delete" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.DELETE,
        "head" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.HEAD,
        "options" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.OPTIONS,
    )
    ...
    val CLIENT_METHOD_GETTERS = mapOf(
        "getGet" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.GET,
        "getPost" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.POST,
        "getPut" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.PUT,
        "getPatch" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.PATCH,
        "getDelete" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.DELETE,
        "getHead" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.HEAD,
        "getOptions" to community.flock.wirespec.extractor.model.Endpoint.HttpMethod.OPTIONS,
    )
